...
<h2 style="text-align: center; color: white;">User Panel</h2>
        ...
        <div class="info">
			<center><form action="" method = "post">
                ...
                <button type="submit" name="button13" onclick="teams()" id="nigger2" class="myButton" style="font-size:100%;"> <i class=""></i>Ban User</button><button type="submit" name="button14" onclick="loli()" id="nigger2" class="myButton" style="font-size:100%;"> <i class=""></i>Unban User</button></form>
...
$sql = "UPDATE users SET ban='yes' WHERE username='$rndm'";
...
// Attempt insert query execution
$sql = "UPDATE users SET ban='no' WHERE username='$rndm'";
if(mysqli_query($link, $sql)){
    echo('');
} else{
    echo "ERROR: Could not able to execute cmd";
...
?>
<br><br> <center><h2 style="color: white;">ALL Registered Users</h2><br>
<?php
